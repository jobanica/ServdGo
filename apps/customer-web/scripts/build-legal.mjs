...
<style>
  ...
  header { border-bottom: 3px solid #E8552F; padding-bottom: .75rem; margin-bottom: 1.5rem; }
  ...
  .note { background: #f8f6f4; border-left: 3px solid #E8552F; padding: .75rem 1rem; margin: 1rem 0; }
