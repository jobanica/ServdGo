...
DEFAULT="create-staff v1-config hq-export track merchant-quote merchant-book merchant-order merchant-cancel merchant-webhooks wallet-topup xendit-webhook xendit-test notify-message"
TARGETS=("${@:-}")
